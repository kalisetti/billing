    ...
    <div class="form-page">
        ...
        <div id="form-body">
            <div id="form-fields" class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        <label for="total-invoice-count">
                            Total No.of Invoices
                            <!-- <i class="bi bi-calendar-month-fill ms-1"></i> -->
                        </label>
                        <input type="number" id="total-invoice-count" class="form-control" 
                            v-model="recordData['total_invoice_count']"
                            disabled
                            >
                    </div>
                    <div class="form-group">
                        <label for="total-invoice-amount">
                            Total Invoice Amount
                            <!-- <i class="bi bi-calendar-month-fill ms-1"></i> -->
                        </label>
                        <input type="number" id="total-invoice-amount" class="form-control" 
                            v-model="recordData['total_invoice_amount']"
                            disabled
                            >
                    </div>
                </div>
...
export default {
    ...
    methods: {
        generateInvoices() {
            axios.post(`/api/generateInvoice.php?table=${this.tableName}&recordId=${this.recordId}`, this.recordData)
                .then((response) => {
                    if (response) {
                        console.error('generateInvoice: ', response);
                    }
